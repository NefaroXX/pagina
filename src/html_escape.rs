...
static ENTITIES: &[(&str, &str)] = &[
    ...
    ("oelig", "œ"), ("Scaron", "Š"), ("scaron", "š"), ("Yuml", "Ÿ"), ("fnof", "ƒ"),
    ("circ", "ˆ"), ("tilde", "˜"), ("Alpha", "Α"), ("Beta", "Β"), ("Gamma", "Γ"),
    ...
    ("euro", "€"), ("trade", "™"), ("bull", "•"), ("hellip", "…"), ("prime", "′"),
    ("Prime", "″"), ("oline", "‾"), ("frasl", "⁄"), ("weierp", "℘"), ("image", "ℑ"),
    ("real", "ℜ"), ("alefsym", "ℵ"), ("larr", "←"), ("uarr", "↑"), ("rarr", "→"),
    ...
    ("hearts", "♥"), ("diams", "♦"), ("thetasym2", "ϑ"), ("Dcaron", "Ď"),
    ("dcaron", "ď"), ("HilbertSpace", "ℋ"), ("DifferentialD", "ⅆ"),
    ("ClockwiseContourIntegral", "∲"), ("CounterClockwiseContourIntegral", "∳"),
    ("ubreve", "ŭ"), ("Ubreve", "Ŭ"), ("ogon", "˛"), ("dblac", "˝"), ("DownBreve", "̑"),
    ("UnderBar", "̱"), ("incare", "℅"), ("gscr", "ℊ"), ("HilbertSpace2", "ℋ"),
    ("Zeta2", "Ζ"), ("phone", "✆"), ("colon", ":"), ("comma", ","), ("period", "."),
    ("sol", "/"), ("bsol", "\\"), ("ndash2", "–"), ("horbar", "―"), ("Vert", "‖"),
    ("frac13", "⅓"), ("frac23", "⅔"), ("frac15", "⅕"), ("frac25", "⅖"), ("frac35", "⅗"),
    ("frac45", "⅘"), ("frac16", "⅙"), ("frac56", "⅚"), ("frac18", "⅛"), ("frac38", "⅜"),
    ("frac58", "⅝"), ("frac78", "⅞"), ("sup4", "⁴"), ("sup5", "⁵"), ("sup6", "⁶"),
    ("sup7", "⁷"), ("sup8", "⁸"), ("sup9", "⁹"), ("sup0", "⁰"), ("iexcl2", "¡"),
    ("QUOT", "\""), ("sol2", "/"), ("Hat", "^"), ("percnt", "%"), ("num", "#"),
    ("dollar", "$"), ("lpar", "("), ("rpar", ")"), ("plus", "+"), ("semi", ";"),
    ("equals", "="), ("quest", "?"), ("commat", "@"), ("lsqb", "["), ("rsqb", "]"),
    ("lcub", "{"), ("rcub", "}"), ("verbar", "|"), ("grave", "`"),
    ("NewLine", "\n"), ("Tab", "\t"), ("NonBreakingSpace", " "),
    ("UnderBracket", "⎵"), ("bbrk", "⎵"), ("OverBracket", "⎴"),
    ("DoubleLeftTee", "⫤"), ("DownArrow", "↓"), ("UpArrow", "↑"),
    ("LeftArrow", "←"), ("RightArrow", "→"), ("UpDownArrow", "↕"),
    ("DoubleDownArrow", "⇓"), ("DoubleUpArrow", "⇑"), ("DoubleLeftArrow", "⇐"),
    ("DoubleRightArrow", "⇒"), ("DoubleLeftRightArrow", "⇔"),
    ("LeftTeeArrow", "↤"), ("UpTeeArrow", "↥"), ("RightTeeArrow", "↦"), ("DownTeeArrow", "↧"),
    ("LongLeftArrow", "⟵"), ("LongRightArrow", "⟶"), ("LongLeftRightArrow", "⟷"),
    ("DoubleLongLeftArrow", "⟸"), ("DoubleLongRightArrow", "⟹"),
    ("DoubleLongLeftRightArrow", "⟺"), ("Map", "⤅"), ("DownTee", "⊤"), ("UpTee", "⊥"),
    ("Cup", "⋓"), ("Cap", "⋒"), ("Square", "□"), ("BlackSquare", "■"),
    ("WhiteCircle", "○"), ("BlackCircle", "●"), ("star", "⋆"), ("check", "✓"),
    ("cross", "✗"), ("malt", "✠"), ("sext", "✶"), ("phone2", "☎"), ("female", "♀"),
    ("male", "♂"), ("musicalnote", "♪"), ("musicalnotes", "♫"), ("sun", "☀"),
    ("cloud", "☁"), ("umbrella", "☂"), ("snowman", "☃"), ("comet", "☄"),
    ("checkmark", "✓"), ("ballot", "✗"), ("heavycheck", "✔"), ("heavycross", "✘"),
    ("Aopf", "𝔸"), ("Bopf", "𝔹"), ("Copf", "ℂ"), ("Dopf", "𝔻"), ("Eopf", "𝔼"),
    ("Fopf", "𝔽"), ("Gopf", "𝔾"), ("Hopf", "ℍ"), ("Iopf", "𝕀"), ("Jopf", "𝕁"),
    ("Kopf", "𝕂"), ("Lopf", "𝕃"), ("Mopf", "𝕄"), ("Nopf", "ℕ"), ("Oopf", "𝕆"),
    ("Popf", "ℙ"), ("Qopf", "ℚ"), ("Ropf", "ℝ"), ("Sopf", "𝕊"), ("Topf", "𝕋"),
    ("Uopf", "𝕌"), ("Vopf", "𝕍"), ("Wopf", "𝕎"), ("Xopf", "𝕏"), ("Yopf", "𝕐"),
    ("Zopf", "ℤ"), ("aopf", "𝕒"), ("bopf", "𝕓"), ("copf", "𝕔"), ("dopf", "𝕕"),
    ("eopf", "𝕖"), ("fopf", "𝕗"), ("gopf", "𝕘"), ("hopf", "𝕙"), ("iopf", "𝕚"),
    ("jopf", "𝕛"), ("kopf", "𝕜"), ("lopf", "𝕝"), ("mopf", "𝕞"), ("nopf", "𝕟"),
    ("oopf", "𝕠"), ("popf", "𝕡"), ("qopf", "𝕢"), ("ropf", "𝕣"), ("sopf", "𝕤"),
    ("topf", "𝕥"), ("uopf", "𝕦"), ("vopf", "𝕧"), ("wopf", "𝕨"), ("xopf", "𝕩"),
    ("yopf", "𝕪"), ("zopf", "𝕫"),
    ("Afr", "𝔄"), ("Bfr", "𝔅"), ("Cfr", "ℭ"), ("Dfr", "𝔇"), ("Efr", "𝔈"),
    ("Ffr", "𝔉"), ("Gfr", "𝔊"), ("Hfr", "ℌ"), ("Ifr", "ℑ"), ("Jfr", "𝔍"),
    ("Kfr", "𝔎"), ("Lfr", "𝔏"), ("Mfr", "𝔐"), ("Nfr", "𝔑"), ("Ofr", "𝔒"),
    ("Pfr", "𝔓"), ("Qfr", "𝔔"), ("Rfr", "ℜ"), ("Sfr", "𝔖"), ("Tfr", "𝔗"),
    ("Ufr", "𝔘"), ("Vfr", "𝔙"), ("Wfr", "𝔚"), ("Xfr", "𝔛"), ("Yfr", "𝔜"),
    ("Zfr", "ℨ"),
    ("Ascr", "𝒜"), ("Cscr", "𝒞"), ("Dscr", "𝒟"), ("Gscr", "𝒢"), ("Jscr", "𝒥"),
    ("Kscr", "𝒦"), ("Nscr", "𝒩"), ("Oscr", "𝒪"), ("Pscr", "𝒫"), ("Qscr", "𝒬"),
    ("Sscr", "𝒮"), ("Tscr", "𝒯"), ("Uscr", "𝒰"), ("Vscr", "𝒱"), ("Wscr", "𝒲"),
    ("Xscr", "𝒳"), ("Yscr", "𝒴"), ("Zscr", "𝒵"), ("ascr", "𝒶"), ("bscr", "𝒷"),
    ("cscr", "𝒸"), ("dscr", "𝒹"), ("fscr", "𝒻"), ("hscr", "𝒽"), ("iscr", "𝒾"),
    ("jscr", "𝒿"), ("kscr", "𝓀"), ("lscr", "𝓁"), ("mscr", "𝓂"), ("nscr", "𝓃"),
    ("pscr", "𝓅"), ("qscr", "𝓆"), ("rscr", "𝓇"), ("sscr", "𝓈"), ("tscr", "𝓉"),
    ("uscr", "𝓊"), ("vscr", "𝓋"), ("wscr", "𝓌"), ("xscr", "𝓍"), ("yscr", "𝓎"),
    ("zscr", "𝓏"),
    ("Abreve", "Ă"), ("abreve", "ă"), ("Aogon", "Ą"), ("aogon", "ą"),
    ("Cacute", "Ć"), ("cacute", "ć"), ("Ccirc", "Ĉ"), ("ccirc", "ĉ"), ("Cdot", "Ċ"),
    ("cdot", "ċ"), ("Ecaron", "Ě"), ("ecaron", "ě"), ("Edot", "Ė"), ("edot", "ė"),
    ("Eogon", "Ę"), ("eogon", "ę"), ("Gbreve", "Ğ"), ("gbreve", "ğ"), ("Gcedil", "Ģ"),
    ("Hcirc", "Ĥ"), ("hcirc", "ĥ"), ("Hstrok", "Ħ"), ("hstrok", "ħ"),
    ("Itilde", "Ĩ"), ("itilde", "ĩ"), ("Imacr", "Ī"), ("imacr", "ī"), ("Iogon", "Į"),
    ("iogon", "į"), ("Idot", "İ"), ("imath", "ı"), ("Jcirc", "Ĵ"), ("jcirc", "ĵ"),
    ("Kcedil", "Ķ"), ("kcedil", "ķ"), ("Lacute", "Ĺ"), ("lacute", "ĺ"),
    ("Lcedil", "Ļ"), ("lcedil", "ļ"), ("Lcaron", "Ľ"), ("lcaron", "ľ"),
    ("Lmidot", "Ŀ"), ("lmidot", "ŀ"), ("Lstrok", "Ł"), ("lstrok", "ł"),
    ("Nacute", "Ń"), ("nacute", "ń"), ("Ncedil", "Ņ"), ("ncedil", "ņ"),
    ("Ncaron", "Ň"), ("ncaron", "ň"), ("Omacr", "Ō"), ("omacr", "ō"),
    ("Odblac", "Ő"), ("odblac", "ő"), ("Racute", "Ŕ"), ("racute", "ŕ"),
    ("Rcedil", "Ŗ"), ("rcedil", "ŗ"), ("Rcaron", "Ř"), ("rcaron", "ř"),
    ("Sacute", "Ś"), ("sacute", "ś"), ("Scirc", "Ŝ"), ("scirc", "ŝ"),
    ("Scedil", "Ş"), ("scedil", "ş"), ("Tcedil", "Ţ"), ("tcedil", "ţ"),
    ("Tcaron", "Ť"), ("tcaron", "ť"), ("Tstrok", "Ŧ"), ("tstrok", "ŧ"),
    ("Utilde", "Ũ"), ("utilde", "ũ"), ("Umacr", "Ū"), ("umacr", "ū"),
    ("Uring", "Ů"), ("uring", "ů"), ("Udblac", "Ű"), ("udblac", "ű"),
    ("Uogon", "Ų"), ("uogon", "ų"), ("Wcirc", "Ŵ"), ("wcirc", "ŵ"),
    ("Ycirc", "Ŷ"), ("ycirc", "ŷ"), ("Zacute", "Ź"), ("zacute", "ź"),
    ("Zdot", "Ż"), ("zdot", "ż"), ("Zcaron", "Ž"), ("zcaron", "ž"),
    ("fnof2", "ƒ"), ("imped", "Ƶ"), ("gamma2", "ɣ"), ("lambda2", "ƛ"),
    ("urio", "ŭ"), ("apos2", "ʼ"), ("lsquor", "‚"), ("ldquor", "„"),
    ("dagger2", "†"), ("Dagger2", "‡"), ("bull2", "•"), ("nldr", "‥"),
    ("hellip2", "…"), ("pertenk", "‱"), ("prime2", "′"), ("Prime2", "″"),
    ("tprime", "‴"), ("backprime", "‵"), ("oline2", "‾"), ("caret", "⁁"),
    ("smile", "⌣"), ("frown", "⌢"), ("target", "⌖"), ("telrec", "⌕"),
    ("topbot", "⎶"), ("bottom", "⊥"), ("bot", "⊥"), ("top", "⊤"),
    ("vzigzag", "⦚"), ("vangrt", "⦜"), ("veebar", "⊻"), ("barvee", "⊽"),
    ("angrtvbd", "⦝"), ("ange", "⦤"), ("range", "⦥"), ("dwangle", "⦦"),
    ("uwangle", "⦧"), ("searhk", "⤥"), ("swarhk", "⤦"), ("nearhk", "⤤"), ("nwarhk", "⤣"),
    ("nwarr", "↖"), ("nearr", "↗"), ("searr", "↘"), ("swarr", "↙"),
    ("nlarr", "↚"), ("nrarr", "↛"), ("rarrw", "↝"), ("larrw", "↜"),
    ("updownarrow", "⇅"), ("Updownarrow", "⇕"), ("RightArrowLeftArrow", "⇄"),
    ("LeftArrowRightArrow", "⇆"), ("leftarrow", "←"), ("rightarrow", "→"),
    ("uparrow", "↑"), ("downarrow", "↓"), ("leftrightarrow", "↔"),
    ("nwarrow", "↖"), ("nearrow", "↗"), ("searrow", "↘"), ("swarrow", "↙"),
    ("hookleftarrow", "↩"), ("hookrightarrow", "↪"), ("looparrowleft", "↫"),
    ("looparrowright", "↬"), ("leftharpoonup", "↼"), ("leftharpoondown", "↽"),
    ("upharpoonright", "↾"), ("upharpoonleft", "↿"), ("rightharpoonup", "⇀"),
    ("rightharpoondown", "⇁"), ("downharpoonright", "⇂"), ("downharpoonleft", "⇃"),
    ("rightsquigarrow", "⇝"), ("leftrightsquigarrow", "↭"), ("UpArrowDownArrow", "⇅"),
    ("Barwed", "⌆"), ("lthree", "⋋"), ("rthree", "⋌"), ("doteq", "≐"),
    ("doteqdot", "≑"), (" risingdotseq", "≓"), ("fallingdotseq", "≒"),
    ("eqcirc", "≖"), ("circeq", "≗"), ("triangleq", "≜"), ("thicksim", "∼"),
    ("thickapprox", "≈"), ("approxeq", "≊"), ("succapprox", "⪸"), ("precapprox", "⪷"),
    ("subseteqq", "⫅"), ("supseteqq", "⫆"), ("subsetneq", "⊊"), ("supsetneq", "⊋"),
    ("varsubsetneq", "⊊"), ("varsupsetneq", "⊋"), ("lessdot", "⋖"), ("gtrdot", "⋗"),
    ("lll", "⋘"), ("ggg", "⋙"), ("lesseqgtr", "⋚"), ("gtreqless", "⋛"),
    ("curlyeqprec", "⋞"), ("curlyeqsucc", "⋟"), ("preccurlyeq", "≼"), ("succcurlyeq", "≽"),
    ("precsim", "≾"), ("succsim", "≿"), ("nprec", "⊀"), ("nsucc", "⊁"),
    ("nsim", "≁"), ("ncong", "≇"), ("napprox", "≉"), ("nequiv", "≢"),
    ("ngeq", "≱"), ("nleq", "≰"), ("ngtr", "≯"), ("nless", "≮"),
    ("ngE", "≧̸"), ("nge", "≱"), ("nges", "⩾̸"), ("nGg", "⋙̸"),    ("vellip", "⋮"), ("ctdot", "⋯"), ("utdot", "⋰"), ("dtdot", "⋱"),
    ("disin", "⋲"), ("isins", "⋳"), ("isindot", "⋵"), ("notindot", "⋵"),
    ("notinvc", "⋶"), ("notinvb", "⋷"), ("isinE", "⋹"), ("nisd", "⋺"),
    ("xnis", "⋻"), ("nis", "⋼"), ("notnivc", "⋽"), ("notnivb", "⋾"),
    (" complement", "∁"), ("eth2", "ð"), (" Abel", "ℬ"),
    ("bernou", "ℬ"), ("Bscr", "ℬ"), ("Cayleys", "ℭ"), ("ccups", "⩌"),
    ("ccaps", "⩍"), ("numero", "№"), ("copysr", "℗"), ("incare2", "℅"),
    ("numero2", "№"), ("rx", "℞"), ("trade2", "™"),
    ("Ohm", "Ω"), ("ohm", "ω"), ("mho", "℧"), ("angstrom", "Å"),
    ("hbar", "ℏ"), ("hslash", "ℏ"), ("ell", "ℓ"), ("numero3", "№"),
    (" naturals", "ℕ"), ("integers", "ℤ"), ("rationals", "ℚ"), ("reals", "ℝ"),
    ("complexes", "ℂ"), ("primes", "ℙ"), (" SuchThat", "∋"),
    ("Backslash", "∖"), ("setminus", "∖"), ("smallsetminus", "∖"),
    ("ast", "∗"), ("circledast", "⊛"), ("circledcirc", "⊚"), ("circleddash", "⊝"),
    ("odot", "⊙"), ("ominus", "⊖"), ("oslash", "⊘"), ("boxminus", "⊟"),
    ("boxplus", "⊞"), ("boxtimes", "⊠"), ("boxdot", "⊡"), ("vdash", "⊢"),
    ("dashv", "⊣"), ("top2", "⊤"), ("models", "⊧"), ("vDash", "⊨"),
    ("Vdash", "⊩"), ("Vvdash", "⊪"), ("VDash", "⊫"), ("nvdash", "⊬"),
    ("nvDash", "⊭"), ("nVdash", "⊮"), ("nVDash", "⊯"), ("prurel", "⊰"),
    ("scurel", "⊱"), ("triangleleft", "⊲"), ("triangleright", "⊳"),
    ("unlhd", "⊴"), ("unrhd", "⊵"), ("multimap", "⊸"), ("mumap", "⊸"),
    ("sqsubset", "⊏"), ("sqsupset", "⊐"), ("sqsub", "⊏"), ("sqsup", "⊐"),
    ("sqsubseteq", "⊑"), ("sqsupseteq", "⊒"), ("diamond", "⋄"), ("cdot2", "⋅"),
    ("star2", "⋆"), ("divideontimes", "⋇"), ("bowtie", "⋈"), ("ltimes", "⋉"),
    ("rtimes", "⋊"), ("leftthreetimes", "⋋"), ("rightthreetimes", "⋌"),
    ("backsimeq", "⋍"), ("curlyvee", "⋎"), ("curlywedge", "⋏"), ("Subset", "⋐"),
    ("Supset", "⋑"), ("Cap2", "⋒"), ("Cup2", "⋓"), ("pitchfork", "⋔"),
    ("lessless", "⪡"), ("greatgreat", "⪢"), ("precneq", "⪵"), ("succneq", "⪶"),
    ("preceq", "⪯"), ("succeq", "⪰"), ("Grand", "⪢"),
    ("Ll", "⋘"), ("Gg", "⋙"), ("questeq", "≟"), ("NotEqualTilde", "≂"),
    ("notapprox", "≉"), ("approx", "≈"), ("simeq", "≃"), ("sime", "≃"),
    ("nsime", "≄"), ("nsimeq", "≄"), ("nsim2", "≁"), ("bcong", "≌"),
    ("cupdot", "⊍"), ("UnionPlus", "⊎"), ("sqcup", "⊔"), ("sqcap", "⊓"),
    ("amalg", "⨿"), ("dagger3", "†"), ("ddagger", "‡"), ("Dagger3", "‡"),
    ("sharp", "♯"), ("flat", "♭"), ("natural", "♮"), ("clubsuit", "♣"),
    ("spadesuit", "♠"), ("heartsuit", "♥"), ("diamsuit", "♦"), ("telephone", "✆"),
    ("circledR", "®"), ("circledS", "Ⓢ"), ("circledC", "©"),
    ("numero4", "№"), ("bigstar", "★"), ("bigcircle", "○"),
    ("blackstar", "★"), ("whitestar", "☆"), ("blackcircle", "●"),
    ("whitecircle", "○"), ("blacksquare", "■"), ("whitesquare", "□"),
    ("blackdiamond", "◆"), ("whitediamond", "◇"), ("blacktriangle", "▲"),
    ("whitetriangle", "△"), ("blacktriangledown", "▼"), ("whitetriangledown", "▽"),
    ("spades2", "♠"), ("clubs2", "♣"), ("hearts2", "♥"), ("diams2", "♦"),
    ("aleph", "ℵ"), ("beth", "ℶ"), ("gimel", "ℷ"), ("daleth", "ℸ"),
    ("ell2", "ℓ"), ("wp", "℘"), ("Re", "ℜ"), ("Im", "ℑ"),
    ("otimesas", "⨶"), ("oplus2", "⊕"), ("otimes2", "⊗"),
    ("plusdo", "∔"), ("minusdo", "∸"), ("dotplus", "∔"), ("setmn", "∖"),
    ("compfn", "∘"), ("cir", "○"), ("circ2", "∘"), ("bullet", "∙"),
    ("infintie", "⧜"), ("tie", "⁀"), ("frown2", "⌢"), ("smile2", "⌣"),
    ("langle", "⟨"), ("rangle", "⟩"), ("Lt", "≪"), ("Gt", "≫"),
    ("Lt2", "≪"), ("Gt2", "≫"), ("hoe", "∘"),
    ("quest2", "?"), ("excl", "!"), ("num2", "#"), ("dollar2", "$"),
    ("percnt2", "%"), ("amp2", "&"), ("lpar2", "("), ("rpar2", ")"),
    ("ast2", "*"), ("plus2", "+"), ("comma2", ","), ("minus2", "-"),
    ("period2", "."), ("sol3", "/"), ("colon2", ":"), ("semi2", ";"),
    ("lt2", "<"), ("equals2", "="), ("gt2", ">"), ("quest3", "?"),
    ("commat2", "@"), ("lsqb2", "["), ("bsol2", "\\"), ("rsqb2", "]"),
    ("hat", "^"), ("lowbar", "_"), ("grave2", "`"), ("lcub2", "{"),
    ("verbar2", "|"), ("rcub2", "}"), ("tilde2", "~"),
    ("ZeroWidthSpace", "​"), ("zws", "​"),
];
